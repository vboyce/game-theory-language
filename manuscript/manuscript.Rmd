...
All experiments were implemented in Empirica (v1). The experiment consisted first of consent and instruction. 
...
```{r,fig.cap="The user interface. Participants saw a reward table and selected what box to open. \\label{ui}"}
